...
friendly = ["Base (number)", "Banzai", "Bracket", "Burn glint", "Buster", 
    "Blank", "Bulldog", "Bump/Bump-up", "Brevity", "Burn glint", "Buster", "Bassett", "Bruiser", "Bulldog", "Cobra", "Cowboys", "Cyclops", "Deadeye",    "Bird", "Bird(s) affirm", "Bird(s) away", "Bird(s) negat", "Bittersweet", "Blue on blue", "Bruiser", "Buddy lock", "Buddy spike", "Bulldog","Cherubs", "Chicks", "Clean", "Chattermark"
]

enemy = ['bandit', 'bogey', 'enemy', 'hostile', "Bandit", "Bogey", "Bassett", "Bruiser", "Bulldog", "Cobra", "Cowboys", 
    "Cyclops", "Deadeye", "Banzai", "Bracket", "Bump","Bump-up", "Burn glint", "Buster", "Blank", 
    "Bulldog", "Brevity", "Bandit", "Bogey", "Bogey dope", "Blow through", "Bloodhound", "Bracket", 
    "Break (direction)", "Breakaway", "Bingo", "Brevity", "Bruiser", 
    "Buddy lock", "Buddy spike", "Bugout", "Buster"
    ] 

navy =["DESTROYER", "DD", "FRIGATE", "FF","CRUISER","CC","SUBMARINE","SUB","CARRIER","CV","vessel"]

air = ["UAV", "BANZAI", "AAV", "A-20 Havoc", "Il-2", "Il-4", "Il-10", "Il-28", "Il-40", "Il-54", 
    "M-4", "M-50", "B-25 Mitchell", "Pe-2", "Tu-2", "Tu-4", "Tu-14", "Tu-16", 
    "Tu-22", "Tu-22M", "Tu-82", "Tu-85", "Tu-91", "Tu-95", "Tu-98", "Tu-160", 
    "Yak-28", "Yak-28B", "MiG-21", "MiG-15", "MiG-17", "MiG-19", "MiG-23", "MiG-25", "MiG-29", "MiG-31",
    "Su-7", "Su-9", "Su-11", "Su-15", "Su-17", "Su-20", "Su-22", "Su-24", "Su-25",
    "Su-27", "Su-30", "Su-33", "Su-35", "Su-57", "Yak-9", "Yak-23", "Yak-25", "Yak-28",
    "Yak-38", "Yak-41", "J-16","CH-SA-3", "CH-SA-4", "CH-SA-6", "CH-SA-7", "CH-SA-8", "CH-SA-10", "CH-SA-15", "CH-SA-16", "CH-SA-N-4","CH-SA-N-9","CH-SA-N-16","CH-SA-N-17","CH-SA-N-21", "SA-N-1 Goa", "SA-N-2 Guideline", "SA-N-3 Goblet", "SA-N-4 Gecko", "SA-N-5 Grail", "SA-N-6 Grumble", "SA-N-7 Gadfly", "SA-N-8 Gremlin", "SA-N-9 Gauntlet", "SA-N-10 Grouse" "SA-N-11 Grison", "SA-N-12 Grizzly", "SA-N-14 Grouse", "SA-N-20 Gargoyle", "SA-1 Guild", "SA-2 Guideline", "SA-3 Goa", "SA-4 Ganef", "SA-5 Gammon", "SA-6 Gainful", "SA-7 Grail", "SA-8 Gecko", "SA-9 Gaskin", "SA-10 Grumble", "SA-11 Gadfly", "SA-12 Gladiator/Giant", "SA-13 Gopher", "SA-14 Gremlin", "SA-15 Gauntlet", "SA-16 Gimlet", "SA-17 Grizzly", "SA-18 Grouse", "SA-19 Grison", "SA-20 Gargoyle", "SA-21 Growler", "SA-22 Greyhound", "SA-23 Gladiator/Giant", "SA-24 Grinch", "SA-X-25 Sosna-R", "SA-26 Pechora-2M", "SA-27 Gollum", "SA-X-28 S-350E Vityaz", "SA-29 Gizmo", 'launch', 'Launch',
    ]
...
def extracted_chat(message):
    ...
    if second_parenthesis_pos != -1:
        ...
        for word in words:
            ...
            if filtered_word_singular in [x.upper() for x in air]:  
