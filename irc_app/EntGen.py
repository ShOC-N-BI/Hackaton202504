...
def action_prompt(entity, description=""):
    ...
    # Return entity and the listed possible actions if actions exist
    action1 = actions[0]
    action2 = actions[1]
    action3 = actions[2]
...
def extracted_chat(message):
    # Initialize default values for entity and actions
    entity, action1, action2, action3 = None, None, None, None
    ...
    if second_parenthesis_pos != -1:
        ...
        for i, word in enumerate(words):
            ...
            if filtered_s in air_enemy:  
                ...
                entity, action1, action2, action3 = action_prompt(filtered_s, description=f"Detected {filtered_s}")

            elif filtered_s in surface:  
                found_surface.append(filtered_s)
                print(f"Found Surface enemy: {filtered_s}")
                entity, action1, action2, action3 = action_prompt(filtered_s)
